...
val mockData = mutableListOf(
    Order(
        ...
        items = mutableListOf(
            OrderItem("1", "Coca-cola Zero", 2, 10.0),
        ...
        deliveryAddress = "Rua Francisco, 123",
        items = mutableListOf(
            OrderItem("1", "Coca-cola", 1, 5.0),
            OrderItem("0", "Guaraná", 1, 5.0)
        ),
        restaurantName = "Lanches Rápidos",
        totalValue = 10.0
    ), Order(
        orderNumber = "1024",
        openingTime = "07/10/2025, 12:00",
        status = OrderStatus.ENTREGUE,
        customerName = "A",
        customerPhone = "A",
        deliveryAddress = "A",
        items = mutableListOf(),
        restaurantName = "X Burguer",
        totalValue = 15.0
    ), Order(
        orderNumber = "1025",
        openingTime = "06/10/2025, 18:30",
        status = OrderStatus.FEITO,
        customerName = "B",
        customerPhone = "B",
        deliveryAddress = "B",
        items = mutableListOf(),
        restaurantName = "Açaí Top",
        totalValue = 25.0
    ), Order(
        orderNumber = "1026",
        openingTime = "05/10/2025, 19:15",
        status = OrderStatus.ENTREGUE,
        customerName = "C",
        customerPhone = "C",
        deliveryAddress = "C",
        items = mutableListOf(),
        restaurantName = "Pizzaria Forno",
        totalValue = 80.0
    ), Order(
        orderNumber = "1027",
        openingTime = "04/10/2025, 22:00",
        status = OrderStatus.ACEITO,
        customerName = "D",
        customerPhone = "D",
        deliveryAddress = "D",
